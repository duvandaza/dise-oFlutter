        ...
        child: Center(
          child: Builder(
            builder: (BuildContext context) { 
              ...
              Provider.of<_SlideshowModel>(context).colorSegundario = this.colorSegundario;

              Provider.of<_SlideshowModel>(context).bulletPrimario = this.bulletPrimario;
              Provider.of<_SlideshowModel>(context).bulletSegundario = this.bulletSegundario;
...
class _Dot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if( ssModel.currentPage >= index - 0.5 && ssModel.currentPage < index + 0.5 ) {
      ...
      tamano = ssModel.bulletSegundario;
      color = ssModel.colorSegundario;
    }
...
class _SlideshowModel with ChangeNotifier {
  ...
  Color _colorSegundario = Colors.grey;
  double _bulletPrimario = 12;
  double _bulletSegundario = 12;
  ...
  set bulletPrimario(double i){
    this._bulletPrimario = i;
  }

  double get bulletSegundario => this._bulletSegundario;
  set bulletSegundario(double i){
    this._bulletSegundario = i;
  }
}